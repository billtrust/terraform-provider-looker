...
func resourceConnectionRead(d *schema.ResourceData, m interface{}) error {
	...
	if err = d.Set("dialect_name", result.Payload.DialectName); err != nil {
		return err
	}
	if err = d.Set("host", result.Payload.Host); err != nil {
		return err
	}
	if err = d.Set("port", result.Payload.Port); err != nil {
		return err
	}
	if err = d.Set("database", result.Payload.Database); err != nil {
		return err
	}
	if err = d.Set("username", result.Payload.Username); err != nil {
		return err
	}
	if err = d.Set("password", result.Payload.Password); err != nil {
		return err
	}
	if err = d.Set("schema", result.Payload.Schema); err != nil {
		return err
	}
	if err = d.Set("jdbc_additional_params", result.Payload.JdbcAdditionalParams); err != nil {
		return err
	}
	if err = d.Set("ssl", result.Payload.Ssl); err != nil {
		return err
	}
	if err = d.Set("db_timezone", result.Payload.DbTimezone); err != nil {
		return err
	}
	if err = d.Set("query_timezone", result.Payload.QueryTimezone); err != nil {
		return err
	}
