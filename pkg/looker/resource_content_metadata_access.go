...
func resourceContentMetadataAccessRead(d *schema.ResourceData, m interface{}) error {
	...
	if err = d.Set("content_metadata_access_id", getStringFromID(access.ID)); err != nil {
		return err
	}
	if err = d.Set("group_id", getStringFromID(access.GroupID)); err != nil {
		return err
	}
	if err = d.Set("content_metadata_id", getStringFromID(access.ContentMetadataID)); err != nil {
		return err
	}
	if err = d.Set("permission_type", access.PermissionType); err != nil {
		return err
	}
