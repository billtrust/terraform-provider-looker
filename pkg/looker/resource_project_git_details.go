...
func resourceProjectGitDetails() *schema.Resource {
	return &schema.Resource{
		...
		Update: resourceProjectGitDetailsUpdate,
...
func resourceProjectGitDetailsRead(d *schema.ResourceData, m interface{}) error {
	...
	if err = d.Set("project_id", result.Payload.ID); err != nil {
		return err
	}
	if err = d.Set("git_remote_url", result.Payload.GitRemoteURL.String()); err != nil {
		return err
	}
