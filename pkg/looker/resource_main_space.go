...
func resourceMainSpaceRead(d *schema.ResourceData, m interface{}) error {
	...
	if err = d.Set("parent_space_name", parentSpace.Name); err != nil {
		return err
	}
	if err = d.Set("parent_content_metadata_id", getStringFromID(parentSpace.ContentMetadataID)); err != nil {
		return err
	}
	...
	if err = d.Set("content_metadata_inherits", contentMetadataResult.Payload.Inherits); err != nil {
		return err
	}
